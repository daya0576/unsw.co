...
def populate():
    ...
    # add_cat('COMP9331', 'http://www.handbook.unsw.edu.au/postgraduate/courses/current/COMP9331.html', views=0, likes=0, level='1', url='Computer Networks and Applications')
